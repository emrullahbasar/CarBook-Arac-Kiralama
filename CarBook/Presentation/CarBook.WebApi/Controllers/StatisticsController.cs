...
namespace CarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAvgRentPriceForMontly()
        {
            var values = await _mediator.Send(new GetAvgRentPriceForMontlyQuery());
            return Ok(values);
        }
        ...
        [HttpGet("GetCarCountByKmHigherThan50kKm")]
        public async Task<IActionResult> GetCarCountByKmHigherThan50kKm()
        {
            var values = await _mediator.Send(new GetCarCountByKmHigherThan50kKmQuery());
            return Ok(values);
        }
